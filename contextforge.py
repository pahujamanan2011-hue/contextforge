...
def is_ignored(path, base_path, ignored_patterns):
    """Checks if a file/folder matches gitignore or default system patterns."""
...
def pack_repository(repo_path, output_file):
    """Traverses the codebase, extracts files, and binds them into a markdown file."""
    ...
    print(f"💡 Copy-paste or drag '{output_file}' directly into ChatGPT or Claude!")
